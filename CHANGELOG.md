...
- **Hide Frame menu item** — new menu bar action that hides the colored frame immediately until the next status change arrives; no settings change required; item is disabled while the frame is already idle
